...
function StateDB(db_path,tree=false,debug=false) {
...
StateDB.prototype._getMultiple = function (adress, startBlockNumber, endBlockNumber, index, array, cb) {
    var self = this;
    ...
    if (startBlockNumber < endBlockNumber) {
        self.getVariable(adress, startBlockNumber, index, function (err, val) {
            ...
            next = buf;
            console.log('_getMultiple:next', next);
            self._getMultiple(adress, next, endBlockNumber, index, array, cb);
        })
    }
    else {
        cb(null, array);
